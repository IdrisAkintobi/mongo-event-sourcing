...
Then you have to:
1. create the config file: Create the file `config/config.js` and opy here the content of [the sample configuration](https://raw.githubusercontent.com/zeppaman/mongo-event-sourcing/main/config/config.js?token=ABK3VC6X45NGR6NJH4E5OM3BC6UCG)
